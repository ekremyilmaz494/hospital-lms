  ...
  components: {
    ...
    schemas: {
      ...
      LoginRequest: {
        ...
        properties: {
          email: { type: 'string', format: 'email', description: 'E-posta adresi', example: 'admin@demo.com' },
          password: { type: 'string', format: 'password', description: 'Sifre (min 8 karakter)', example: 'demo123456' },
        },
      },
