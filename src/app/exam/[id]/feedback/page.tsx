  ...
  return (
    <div className="fb-root">
      ...
      <style jsx>{`
        ...
        .fb-likert-cell:hover { border-color: #d9d4c4; background: #faf8f2; }
        .fb-likert-cell-on {
          background: #0a7a47;
          border-color: #0a7a47;
        ...
        .fb-likert-cell-on .fb-likert-value { color: #fafaf7; }
        .fb-likert-label {
          font-family: var(--font-display, system-ui);
          font-size: 10px;
          font-weight: 600;
        ...
        .fb-ypn-cell:hover { border-color: #d9d4c4; background: #faf8f2; }
        .fb-ypn-cell-on {
          background: #0a7a47;
          border-color: #0a7a47;
          color: #fafaf7;
        ...
        .fb-btn-ghost:hover { border-color: #0a0a0a; color: #0a0a0a; }
        .fb-btn-primary {
          background: #0a7a47;
          color: #fafaf7;
