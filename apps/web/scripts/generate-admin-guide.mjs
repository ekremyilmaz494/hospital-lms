...
const SECTIONS = [
  ...
  {
    id: 5, title: 'Personel', path: '/admin/staff', icon: '◎',
  ...
  {
    id: 6, title: 'Sertifikalar', path: '/admin/certificates', icon: '★',
  ...
  {
    id: 7, title: 'Uyum Raporu', path: '/admin/compliance', icon: '⊙',
  ...
  {
    id: 8, title: 'Yetkinlik Matrisi', path: '/admin/competency-matrix', icon: '▦',
  ...
  {
    id: 9, title: 'Etkinlik Analizi', path: '/admin/effectiveness', icon: '▲',
  ...
  {
    id: 10, title: 'Geri Bildirim Formları', path: '/admin/feedback-forms', icon: '✎',
  ...
  {
    id: 11, title: 'SMG Takibi', path: '/admin/smg', icon: '☆',
  ...
  {
    id: 12, title: 'Raporlar', path: '/admin/reports', icon: '◰',
  ...
  {
    id: 13, title: 'Bildirimler', path: '/admin/notifications', icon: '◈',
  ...
  {
    id: 14, title: 'İşlem Geçmişi (Audit Log)', path: '/admin/audit-logs', icon: '◵',
  ...
  {
    id: 15, title: 'Akreditasyon', path: '/admin/accreditation', icon: '✓',
  ...
  {
    id: 16, title: 'Ayarlar', path: '/admin/settings', icon: '⚙',
